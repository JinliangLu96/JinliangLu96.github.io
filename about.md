...
1. Jinliang Lu and Jiajun Zhang. **Select Best Translation from Different Systems without Reference**. *To Appear in NLPCC 2019*. 
2. Jinliang Lu and Jiajun Zhang. **基于多语言预训练语言模型的译文质量估计方法**. (**Best Paper Award**) *To Appear in CCMT 2019*
